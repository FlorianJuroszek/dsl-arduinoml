...
public class State_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_9xz71f_a(), CONCEPTS.State$3n));
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for State. Generated from implicit smart reference attribute.", new SNodePointer("r:1e4e32fc-e42a-4b05-84e5-5f0ea797c86d(ArduinoML.structure)", "3943742123535526383")));
    try {
  ...
  public class SMP_ReferenceScope_9xz71f_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_9xz71f_a() {
      ...
      super((SAbstractConcept) CONCEPTS.State$3n, LINKS.next$LKAs);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_9xz71f_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.State$3n);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
