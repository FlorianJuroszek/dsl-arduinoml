...
/*package*/ class DigitalPredicate_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DigitalPredicate_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_tkv4m_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "[digital predicate]");
    editorCell.setCellId("Constant_tkv4m_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.sensor$FWlq;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.sensor$FWlq);
    }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_tkv4m_d0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.value$MqOG;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
