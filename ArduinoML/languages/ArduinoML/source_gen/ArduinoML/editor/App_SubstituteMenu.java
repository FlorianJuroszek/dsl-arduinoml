...
public class App_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_u5o6fv_a(), CONCEPTS.App$hq));
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for App. Generated from implicit smart reference attribute.", new SNodePointer("r:1e4e32fc-e42a-4b05-84e5-5f0ea797c86d(ArduinoML.structure)", "3943742123535526391")));
    try {
  ...
  public class SMP_ReferenceScope_u5o6fv_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_u5o6fv_a() {
      ...
      super((SAbstractConcept) CONCEPTS.App$hq, LINKS.initial_state$5h6z);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_u5o6fv_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.App$hq);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
