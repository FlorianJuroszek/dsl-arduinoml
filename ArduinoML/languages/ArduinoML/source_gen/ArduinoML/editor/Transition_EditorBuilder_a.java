...
/*package*/ class Transition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.sensor$FmZ1;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.sensor$FmZ1);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.value$Fn0u;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
