...
/*package*/ class Transition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new tupleListHandler_jj4qz_a1a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_tuple");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private static class tupleListHandler_jj4qz_a1a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public tupleListHandler_jj4qz_a1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.tuple$SMtV;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Predicate$jn;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(tupleListHandler_jj4qz_a1a.this.getNode(), LINKS.tuple$SMtV));
      try {
    ...
    private EditorCell createConstant_1() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "no tuple defined");
      editorCell.setCellId("Constant_jj4qz_a0b0");
      editorCell.setDefaultText("");
      return editorCell;
    }
  }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "then move to state");
    editorCell.setCellId("Constant_jj4qz_a2a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.next$FmK0;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.next$FmK0);
    }
