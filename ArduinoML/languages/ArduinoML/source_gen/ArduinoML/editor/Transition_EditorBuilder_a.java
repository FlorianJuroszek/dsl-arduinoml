...
/*package*/ class Transition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new tupleListHandler_jj4qz_a0a(myNode, getEditorContext());
  ...
  private static class tupleListHandler_jj4qz_a0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public tupleListHandler_jj4qz_a0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(tupleListHandler_jj4qz_a0a.this.getNode(), LINKS.tuple$SMtV));
      try {
